...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for tour-audio" ON storage.objects FOR SELECT USING (bucket_id = 'tour-audio');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for tour-audio" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'tour-audio');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for tour-audio" ON storage.objects FOR UPDATE USING (bucket_id = 'tour-audio');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for tour-audio" ON storage.objects FOR DELETE USING (bucket_id = 'tour-audio');`
    ];
